...
#	},
	...
	{	menu => _('Play, queue or track'),	title => _("#"), width => 20,
	...
	rownumber=>
	{	menu => _("Row number"),	title => _("#"),		width => 50,
		value => sub { $_[1]+1 },
...
{	my ($class,$opt)= @_;
	...
	my $Bplay=::NewIconButton('gmb-media-play',undef,sub
		{	my $self= $_[0]->GET_ancestor;
...
{	my $self=shift;
	...
	{	my $list;
		...
		my $format=	$field eq 'album'	? _"<b>%a</b>%Y\n<small>%s by %b</small>":
				$field=~m/^artists?$/	? _"<b>%a</b>\n<small>%x %s%Y</small>"	:
				$field eq 'title'	? _"<b>%t</b>\n<small><small>by</small> %a <small>from</small> %l</small>":
							  "<b>%a</b> (<small>%s</small>)";
